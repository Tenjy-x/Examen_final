    ...
    <div class="col-lg-6 ms-auto mt-3">
        <div class="row">
            <div class="col-lg-8">
                ...
                <p class = "card-text fs-6"><i class = "bi bi-geo-alt-fill"></i><?php echo $fiche['nom_objet']?></p>
            </div>
            <div class="col-4 ms-auto">
                <p class = " fw-bold fs-4 d-flex justify-content-end text-danger"><i class = "bi bi-currency-dollar"></i></p>
            </div>
        </div>
